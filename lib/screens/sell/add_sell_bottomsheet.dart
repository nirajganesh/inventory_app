...
class add_sell_bottomsheet extends StatefulWidget {
  ...
  @override
  _add_sell_bottomsheetState createState() => _add_sell_bottomsheetState();
}

class _add_sell_bottomsheetState extends State<add_sell_bottomsheet> {
          ...
          children: [
            Row(
              children: [
                Expanded(
                  flex: 1,
                  child: Center(child: Divider(color: HexColor("#0c0c0c"),
                    height: 4,)),
                )
              ],
            ),
            ...
            Row(
              ...
              children: <Widget>[
                RaisedButton(
                  onPressed: widget.close, color: Colors.white, elevation: 0,
            ...
            Center(
              child: Text(
                "Add Sell", style: (TextStyle(color: HexColor("#0c0c0c"),
                  fontSize: 18,
            ...
            Padding(
              ...
              child: Container(
                ...
                height: 44,
                child: TextField(controller: add_sell_bottomsheet
                    .retailercontroller,
  ...
  check_data() {
    if (add_sell_bottomsheet.retailercontroller.text.toString() == '') {
