...
class add_payment_bottomsheet extends StatefulWidget {
  ...
  @override
  _add_payment_bottomsheetState createState() => _add_payment_bottomsheetState();

}

class _add_payment_bottomsheetState extends State<add_payment_bottomsheet> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Center(
              child: Text(
                "Add Payment",style: (TextStyle(color: HexColor("#0c0c0c"),fontSize: 18,fontWeight:FontWeight.bold,fontFamily:'Montserrat_bold')),
              ),
            ),
            SizedBox(height: 20,),
            Padding(
  ...
  check_data() {
    if(add_payment_bottomsheet.clientcontroller.text.toString()=='')
    {
