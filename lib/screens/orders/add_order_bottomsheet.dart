...
class add_order_bottomsheet extends StatefulWidget {
  ...
  @override
  _add_order_bottomsheetState createState() => _add_order_bottomsheetState();
}

class _add_order_bottomsheetState extends State<add_order_bottomsheet> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Center(
              child: Text(
                "Add Orders",style: (TextStyle(color: HexColor("#0c0c0c"),fontSize: 18,fontWeight:FontWeight.bold,fontFamily:'Montserrat_bold')),
              ),
            ),
            SizedBox(height: 20,),
            Padding(
              ...
              child: Container(
                ...
                height: 44,
                child: TextField(controller: add_order_bottomsheet
                    .clientcontroller,
  ...
  check_data() {
    if(add_order_bottomsheet.clientcontroller.text.toString()=='')
    {
