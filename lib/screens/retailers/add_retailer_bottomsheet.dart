...
class add_retailer_bottomsheet extends StatefulWidget {
  ...
  @override
  _add_retailer_bottomsheetState createState() => _add_retailer_bottomsheetState();
}

class _add_retailer_bottomsheetState extends State<add_retailer_bottomsheet> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Center(
              child: Text(
                "Add Retailer",style: (TextStyle(color: HexColor("#0c0c0c"),fontSize: 18,fontWeight:FontWeight.bold,fontFamily:'Montserrat_bold')),
              ),
            ),
            SizedBox(height: 20,),
            Padding(
  ...
  check_data() {
    if(add_retailer_bottomsheet.clientcontroller.text.toString()=='')
    {
